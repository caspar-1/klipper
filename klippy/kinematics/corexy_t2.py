# Code for handling the kinematics of Type2 corexy robots
#
...
class CoreXY_T2_Kinematics:
    def __init__(self, toolhead, config):
        ...
        self.rails[0].setup_itersolve('corexy_t2_stepper_alloc', 'A')
        self.rails[1].setup_itersolve('corexy_t2_stepper_alloc', 'B')
...
def load_kinematics(toolhead, config):
    return CoreXY_T2_Kinematics(toolhead, config)
